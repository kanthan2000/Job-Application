...
import Spinner from '../../Spinner/Spinner.js';
	...
	React.useEffect( ()=> {
			handleChangePage(1)
			axios.get("http://35.154.117.105:8080/candidate").then(response=>{
		...
		React.useEffect(() => {
			axios.get("http://35.154.117.105:8080/candidateCount").then(({data}) => {
	...
	const handleChangePage = (currentPage) => {
		...
		let url = `http://35.154.117.105:8080/candidate?size=${rowsPerPage}&page=${paramPage}`
		loadUsers(url)
	};
	const getUser = async (userId) => {
		return await axios.get(`http://35.154.117.105:8080/candidate/${userId}`)
	}
	...
	const onhandleDelete = async (userId)=>{
		console.log(userId)
		setLoad(true)
		let user = await axios.delete(`http://35.154.117.105:8080/candidate/?id=${userId}`)
		console.log(user, candidates)
		let url = `http://35.154.117.105:8080/candidate?size=${rowsPerPage}&page=${0}`
		loadUsers(url)
	}
